...
public class DataFrameStatsTest {
    ...
    private DataFrame dataFrame = new DataFrame(mIndexes, mLabels, Arrays.asList("23.5","54.2","NaN","A weird value"),Arrays.asList(2,5,6,5),Arrays.asList(245.2,12.2,12.1,122));

    @Test
    public void test_sum(){
        List<Double> expectedList = Arrays.asList(77.7,18.0,391.5);//somme des colonnes
    ...
    public void test_sum_axis1(){
        List<Double> expectedList = Arrays.asList(270.7, 71.4, 18.1, 127.0);//somme des lignes
    ...
    public void test_sum_skipna_false(){
        List<Double> expectedList = Arrays.asList(270.7, 71.4, Double.parseDouble("NaN"), Double.parseDouble("NaN"));//somme des lignes
    ...
    public void test_min(){
        List<Double> expectedList = Arrays.asList(23.5,2.0,12.1);//min des colonnes
    ...
    public void test_min_axis1(){
        List<Double> expectedList = Arrays.asList(2.0,5.0,6.0,5.0);//min des lignes
